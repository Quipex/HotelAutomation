...
const parseCmdFindUnreadNotifications = async (ctx: Context, originalMessageId?: number) => {
  const unreadNotifications = await BookingNotificationService.getUnreadNotifications();
...
export { parseCmdFindUnreadNotifications };
